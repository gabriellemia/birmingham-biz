  ...
  return (
    <>
      <article>
        ...
        <hr></hr>
        <p>
          Burntwood-based homebuilder Cameron Homes has launched a 12-month calendar of celebrations to mark 30 years of
          building homes across the Midlands.
        </p>
        ...
        <p>
          ...
          projects and initiatives through The Noel Sweeney Foundation - Tara Groups charitable trust, which was founded
          in memory of Noel Sweeney.
        </p>
        <p>
          Celebrations for the 30th anniversary begin with events at current developments including Amber Grove in Kirk
          Langley, Sutton Park Grange in Kidderminster and Eaton Grange in Swadlincote. They will be followed by a
          12-month programme of events, initiatives and charitable projects in the local communities that Cameron Homes
          operates in.
        </p>
        <p>
      ...
      <aside>
        <div className={styles.adcontainer}>
          <Image src="/1663_1.jpg" fill={true} className={styles.adimage} alt="Advertisement" />
        </div>
        <h2>Most Popular</h2>
        <hr></hr>
        <MostPopularAside
